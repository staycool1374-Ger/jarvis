...
/// @brief Read a 64-bit random value using the ARM RNG system register
/// (s3_3_c2_c4_0).
/// @param[out] out Filled with a random 64-bit value.
/// @return Always true (the system register always provides a value).
/// @note Uses the ARMv8.5 RNG architectural feature via implementation-specific
/// sysreg.
...
/// @brief Read a 64-bit seed value using the ARM RNG system register
/// (s3_3_c2_c4_1).
