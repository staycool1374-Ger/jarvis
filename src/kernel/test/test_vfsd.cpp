...
JARVIS_TEST(vfsd_kernel_bypass_write, "PRE: vfsd, iocd | POST: none") {
    ...
    const char *msg = "test";
    uint64_t ret =
        Syscall::handle(static_cast<uint64_t>(SyscallNumber::WRITE), fd,
...
JARVIS_TEST(vfsd_kernel_bypass_stat, "PRE: vfsd, iocd | POST: none") {
    ...
    vfs::VfsStat st{};
    uint64_t ret =
        Syscall::handle(static_cast<uint64_t>(SyscallNumber::STAT),
...
JARVIS_TEST(vfsd_kernel_bypass_fstat, "PRE: vfsd, iocd | POST: none") {
    ...
    vfs::VfsStat st{};
    uint64_t ret =
        Syscall::handle(static_cast<uint64_t>(SyscallNumber::FSTAT), fd,
                        reinterpret_cast<uint64_t>(&st), 0, 0, nullptr);
    JARVIS_ASSERT_EQ(0ULL, ret);
